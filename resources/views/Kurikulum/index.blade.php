...
<script type="text/javascript">
    ...
    function add() {
        location.href='/akbid/kurikulum/add';
    }

    function edit(id) {
        location.href='/akbid/kurikulum/edit/'+id;
    }
    function detail(id) {
        location.href='/akbid/kurikulum/detail/data/'+id;
    }
    ...
    function deleteConfirm() {
        ...
        var data = {
                "id_kurikulum" : selectedID,
                "_token" : _token};

          $.ajax({
             type: 'delete',
             url: '{{url("/kurikulum/delete")}}',
             data: data,
