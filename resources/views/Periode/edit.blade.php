      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box box-primary">
            ...
            {!! Form::open(array('route' => 'putPeriode','files'=>true, 'id' => 'contact_form', 'method' => 'PUT')) !!}
            <div class="box-body"> 

                <div class="form-group" hidden>
                  <label>ID Periode</label>  
                  <input  name="id_periode" id="id_periode" required placeholder="Masukkan Tahun Periode" class="form-control" type="text" value="{{ $periode['id_periode'] }}">
                </div>

                <div class="form-group">
                  <label>Periode</label>  
                  <input name="periode" id="periode" required placeholder="Masukkan Tahun Periode" class="form-control" type="text" value="{{ $periode['periode'] }}">
                </div>
