...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li class="active"><a href="#"><i class="fa fa-book"></i>Transkrip Nilai Mahasiswa</a></li>
      </ol>
    </section>
...
<script type="text/javascript">
    ...
    function detail(nomor_id) {
        location.href='/akbid/mahasiswa/transkrip/detail/'+nomor_id;
    }
    ...
    function deleteConfirm() {
        ...
        var data = {
          ...
          $.ajax({
             type: 'delete',
             url: '{{url("/akbid/mahasiswa/delete")}}',
             data: data,
