...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li class="active"><a href="#"><i class="fa fa-archive"></i>Transkrip Nilai</a></li>
      </ol>
    </section>
              ...
              <div class="box-header">
                        ...
                        <div class="pull-right">
                          <!-- <button type="button" onclick="window.history.go(-1); return false;" class="btn btn-warning btn-block btn-flat">Kembali</button> -->
                            <button type="button" class="add-modal btn btn-warning" onclick="location.href='/akbid/mahasiswa/transkrip/data'; return false;"><span class="glyphicon glyphicon-back"></span> Kembali</button>
                            <a type="button" class="add-modal btn btn-success" href="{{ route('transkripNilaiPdf',['download'=>'pdf', 'nomor_id' => $mahasiswa->nomor_id]) }}" target="_blank"><span class="glyphicon glyphicon-print"></span> Cetak</a>
...
<script type="text/javascript">
  ...
  function cari() {
    ...
    location.href='/mahasiswa/khs/'+smt;
  }
