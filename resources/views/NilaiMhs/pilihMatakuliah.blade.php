                ...
                <div class="box box-primary">
                    ...
                    <div class="box-header">
                        ...
                        <div class="pull-left">
                            ...
                            <a type="button" href="{{ route('mahasiswa.nilai.index') }}" class="add-modal btn btn-success" onclick="add()"><span class="glyphicon glyphicon-arrow-left"></span> Kembali</a>
                        </div>    
                         <!--Include Modal  -->
...
<script type="text/javascript">
    ...
    function deleteConfirm() {
        ...
        var data = {
          ...
          $.ajax({
             type: 'delete',
             url: '{{url("/akbid/mahasiswa/nilai/delete")}}',
             data: data,
