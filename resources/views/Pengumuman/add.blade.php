      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box box-primary">
            ...
            {!! Form::open(array('route' => 'postPengumuman','files'=>true, 'id' => 'contact_form')) !!}
            <div class="box-body"> 

                <div class="form-group">
                  <label>Judul Pengumuman</label>  
                  <input name="judul" id="judul" required placeholder="Masukkan Judul Pengumuman" class="form-control" type="text">
                </div>

                <div class="form-group">
                  <label>Judul Pengumuman</label>  
                  <textarea class="textarea form-control" name="konten" placeholder="" style="height: 400px"></textarea>
                </div>
