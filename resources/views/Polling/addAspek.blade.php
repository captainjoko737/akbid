      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box box-primary">
            ...
            {!! Form::open(array('route' => 'postAspek','files'=>true, 'id' => 'contact_form')) !!}
            <div class="box-body"> 

                <div class="form-group" hidden>
                  <label>ID Polling</label>  
                  <input name="id_polling" id="id_polling" required placeholder="Masukkan Nama Aspek" class="form-control" type="text" value=" {{ $id_polling }}">
                </div>

                <div class="form-group">
                  <label>Nama Aspek</label>  
                  <input name="nama_aspek" id="nama_aspek" required placeholder="Masukkan Nama Aspek" class="form-control" type="text">
                </div>
