      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box box-primary">
            ...
            {!! Form::open(array('route' => 'postPolling','files'=>true, 'id' => 'contact_form')) !!}
            <div class="box-body"> 
                ...
                <div class="form-group">
                  ...
                  <input name="jumlah_polling" id="jumlah_polling" required placeholder="Masukkan Jumlah Polling" class="form-control" type="text">
                </div>

                <div class="form-group">
                  <label>Persentase Polling</label>  
                  <input name="persentase_poling" id="persentase_poling" required placeholder="Masukkan Persentase Polling" class="form-control" type="text">
                </div>
